...
#ifndef LIBRARY_SOCKET_HELPER_H_
#define LIBRARY_SOCKET_HELPER_H_

#include	"../config/config.h"	/* configuration options for current OS */
...
#endif /* LIBRARY_SOCKET_HELPER_H_ */
